...
def show_alerts_page():
    ...
    try:
        ...
        with tab1:
            ...
            with col2:
                if st.button("🔄 Skanuj Teraz", use_container_width=True):
...
def show_autonomous_conversations_page():
    ...
    with col1:
        if st.button("🚀 Uruchom nową rozmowę", type="primary", use_container_width=True):
    ...
    with col3:
        if st.button("📊 Szczegóły API", use_container_width=True):
...
def show_notifications_page():
    ...
    with col2:
        if st.button("🧪 Wyślij test email", use_container_width=True):
            if not enabled:
    ...
    **System konsultacji** pozwala zapytać Radę Partnerów o opinię na dowolny temat.
    ...
    with tab1:
        ...
        with st.form("new_consultation_form"):
            ...
            submitted = st.form_submit_button("📤 Wyślij do Rady", type="primary", use_container_width=True)
...
def show_snapshots_page():
    ...
    with tab1:
        ...
        st.plotly_chart(fig1, use_container_width=True, key="snapshot_networth_chart")
        ...
        st.plotly_chart(fig2, use_container_width=True, key="snapshot_components_chart")
        ...
        if net_worths:
            ...
            st.plotly_chart(fig3, use_container_width=True, key="snapshot_percent_change_chart")
